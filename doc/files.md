...
wch.conf           | contains configuration settings for wchd or wch-qt
wchd.pid           | stores the process id of wchd while running
...
debug.log           | contains debug information and general logging generated by wchd or wch-qt
