Contributing to WeCash Core
============================

The WeCash Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/WeCash/WeCash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the WeCash Core project, and is not to be
confused with overall WeCash Network Protocol consensus changes.

Whether a pull request is merged into WeCash Core rests with the project merge
...
Patches that change WeCash consensus rules are considerably more involved than
...
Where a patchset proposes to change the WeCash consensus, it must have been
...
The project leader is the release manager for each WeCash Core release.
