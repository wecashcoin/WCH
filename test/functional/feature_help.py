...
"""Verify that starting wch with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wch with -? for help text")
        ...
        self.log.info("Start wch with -version for version information")
