...
/* WeCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WeCash"
#define QAPP_ORG_DOMAIN "wch.cash"
#define QAPP_APP_NAME_DEFAULT "WeCash-Qt"
#define QAPP_APP_NAME_TESTNET "WeCash-Qt-testnet"
