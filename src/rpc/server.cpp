...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WCH features */
        {"wch", "listmasternodes", &listmasternodes, true },
        {"wch", "getmasternodecount", &getmasternodecount, true },
        {"wch", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"wch", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"wch", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"wch", "masternodecurrent", &masternodecurrent, true },
        {"wch", "startmasternode", &startmasternode, true },
        {"wch", "createmasternodekey", &createmasternodekey, true },
        {"wch", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"wch", "listmasternodeconf", &listmasternodeconf, true },
        {"wch", "getmasternodestatus", &getmasternodestatus, true },
        {"wch", "getmasternodewinners", &getmasternodewinners, true },
        {"wch", "getmasternodescores", &getmasternodescores, true },
        {"wch", "preparebudget", &preparebudget, true },
        {"wch", "submitbudget", &submitbudget, true },
        {"wch", "mnbudgetvote", &mnbudgetvote, true },
        {"wch", "getbudgetvotes", &getbudgetvotes, true },
        {"wch", "getnextsuperblock", &getnextsuperblock, true },
        {"wch", "getbudgetprojection", &getbudgetprojection, true },
        {"wch", "getbudgetinfo", &getbudgetinfo, true },
        {"wch", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"wch", "mnfinalbudget", &mnfinalbudget, true },
        {"wch", "checkbudgets", &checkbudgets, true },
        {"wch", "mnsync", &mnsync, true },
        {"wch", "spork", &spork, true },
        {"wch", "getcollateral", &getcollateral, true},
...
{
    return "> wch-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:38245/\n";
}
