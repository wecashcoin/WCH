...
{
    const char* pszTimestamp = "Boom shakalaka boom boom";
    const CScript genesisOutputScript = CScript() << ParseHex("045e63a18492cc2280d9ec9fe1086a97970cd397372ca89fc4e164c0c8c10e19c71cf0eaf483ba87c861cd8ad6b9a851c14ef95cb994d94835ab363f03772a3ddd") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1695108868, // * UNIX timestamp of last checkpoint block
...
/*
        ...
        // /////////////////////////////////////////////////////////////////
         ...
         uint32_t nGenesisTime = 1695108868;
         arith_uint256 test;
         bool fNegative;
         bool fOverflow;
        ...
        // /////////////////////////////////////////////////////////////////
*/
        genesis = CreateGenesisBlock(1695108868, 208508, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a896b24cd6a83332da829e6bb39be7871e201e4e3b2b9797d6cef7309c5"));
        assert(genesis.hashMerkleRoot == uint256S("0x6cb974c0260724e0b5b873992fe51541de4efde9ddf88ebdd483fc310db37f45"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04f9c85fd1ae17a44fac3f47a90e819bc25f7155abd29ba419e9cc08b8f7ddb9b7b19995a4269372e4573b4a806d94cf38bd8e2fe24dba28b33af459319728331f";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "WURqNTdFBd2NpkTsq1YRihsQpvQKzqa7c3";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.wch.cash"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.wch.cash"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.wch.cash"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.wch.cash"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.wch.cash"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.wch.cash"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.wch.cash"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.wch.cash"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 73);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 28);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 48);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xD6)(0x4B)(0xAC)(0x4F).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xD6)(0x4B)(0x6E)(0x39).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x3C)(0x43)(0xBA).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // wch starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet wch addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet wch script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet wch BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet wch BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet wch BIP44 coin type is '1' (All coin's testnet default)
