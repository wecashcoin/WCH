...
#define MyAppName "WeCash"
#define MyAppPublisher "2022 WeCash developers"
#define MyAppURL "https://wch.cash/"
#define MyAppExeName "wch-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/WCH/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=WeCashSetup
...
[Files]
Source: ".\package\wch-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\WeCash\WeCash-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\WeCash\WeCash-Qt,strDataDir|{userappdata}\WeCash\}');
  Result := True;
end;
