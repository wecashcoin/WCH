...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='wch.conf'
CONFIGFOLDER='/root/.wch'
COIN_DAEMON='wchd'
COIN_CLI='wch-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/WeCash/WeCash/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
